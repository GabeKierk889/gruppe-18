...
public class DiceGame {
    public static void main(String[] args) {
        Field[] gameField = {
                new Field(null,null,false,0),new Field(null,null,false,0), // empty array placeholders to allow array index to match up to 2-12
                ...
                new Field("Mountain Huts","You made it to some Huts in the Mountain - a generous mountain dweller gives you 60 in pocket money for your onward journey", true, 60),
