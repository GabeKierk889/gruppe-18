public class Board {
    ...
    public Board() {
        fields = new Field[]{
                new Field("Start"), new AmusementField("The Burger Bar",1),
                new AmusementField("The Pizzeria",1), new Field("Chance"),
                new AmusementField("The Candy Shop",1), new AmusementField("The Ice Cream Shop",1),
                new Field("Visit to Jail"), new AmusementField("The Museum",2),
                new AmusementField("The Library",2), new Field("Chance"),
                ...
                new AmusementField("The Cinema",3), new Field("Chance"),
                ...
                new AmusementField("The Zoo",4), new Field("Chance"),
