...
public class ChanceCardsCreator {
    public ChanceCard[] createChanceCardsDeck() {
        ...
        return new ChanceCard[]{
                ...
                new MoveXFieldsForwardCard(text[27],numbersInChanceCardText[27]),
                new MoveXFieldsBackwardsCard(text[28],numbersInChanceCardText[28]),
                new MoveXFieldsBackwardsCard(text[29],numbersInChanceCardText[29]),
